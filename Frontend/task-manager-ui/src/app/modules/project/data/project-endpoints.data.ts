...
export const projectEndpoints: EndpointDefinition[] = [
  {
    ...
    bodyFields: [
      { key: 'projectName', label: 'Project Name', type: 'text', required: false, placeholder: 'Task Manager' },
  ...
  },
  {
    ...
    queryParams: [{ key: 'keyword', label: 'Keyword', type: 'text', required: false, placeholder: 'Task' }],
  },
  {
