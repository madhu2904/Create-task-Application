...
export const notificationEndpoints: EndpointDefinition[] = [
  {
    ...
    bodyFields: [
      { key: 'text', label: 'Text', type: 'textarea', required: false, placeholder: 'Notification message' },
  ...
  },
  {
    ...
    pathParams: [{ key: 'notificationId', label: 'Notification Id', type: 'text', required: false, placeholder: '1' }],
  },
  {
