...
export const collaborationEndpoints: EndpointDefinition[] = [
  {
    ...
    bodyFields: [
      { key: 'text', label: 'Comment Text', type: 'textarea', required: false, placeholder: 'Looks good to me' },
  ...
  },
  {
    ...
    pathParams: [{ key: 'commentId', label: 'Comment Id', type: 'text', required: false, placeholder: '1' }],
  },
  {
    ...
    pathParams: [{ key: 'taskId', label: 'Task Id', type: 'text', required: false, placeholder: '1' }],
    bodyFields: [
      { key: 'fileName', label: 'File Name', type: 'text', required: false, placeholder: 'spec.pdf' },
      { key: 'filePath', label: 'File Path', type: 'text', required: false, placeholder: '/files/spec.pdf' },
    ],
  },
  {
  ...
  },
  {
    ...
    pathParams: [{ key: 'attachmentId', label: 'Attachment Id', type: 'text', required: false, placeholder: '1' }],
  },
];